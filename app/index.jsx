...
<View className='w-full flex  items-center h-full justify-center px-4'>
...
<Text className="text-3xl text-white font-bold text-center">Discover Endless Possibities with {" "}
...
<Text className="text-sm font-pregular text-gray-100 mt-7 text-center">Where creativity meets innovation:
  embark on a journey of limitless exploration with Auro
</Text>
